...
public class NumberEx {
	...
	public static void main(String[] args) {
		...
		//NumberFormat은 new예약어를 통한 객체를 생성하지 않는다.
		//예) NumberFormat nf = NumberFotmat.getInstance();
		// => 결과는 천단위 마다 ,(콤마)를 출력하는 메서드이다.
		...
		//java.text.DecimalFormat@674dc => 현재 num1의 참조 주소
		// Heap주소 => Heap안에 값이 존재함
		// 반드시 접근할 수 있는 메서드를 선택해야한다.
		// NumberFormat의 출력 메소드는 : 참조변수.format(값)
